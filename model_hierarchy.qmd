...
data <- get_hierarchy_model_data() |> drop_na(UBPRE524.diff.lag4) |> 
...
#HasPartner   0.02334    0.02475   0.943
m <- lmer(UBPRE524.diff ~ HasPartner + (1 + HasPartner | BankType/BankName/Partner), data = data, REML = TRUE)
summary(m)
coef(m)
#                       Estimate Std. Error t value
# HasPartner            0.02206    0.01881   1.173
m <- lmer(UBPRE524.diff ~ HasPartner + (1 + HasPartner + UBPRB538.pct_change | BankType/BankName/Partner) + RRSFS.Pop.log.diff + UNRATE.log.diff + UNRATE.log.diff.lag1 , data = data, REML = TRUE)
summary(m)
coef(m)

#                       Estimate Std. Error t value
# HasPartner1           0.015550   0.014454   1.076
m <- lmer(UBPRE524.diff ~ HasPartner + (1 + HasPartner + UBPRB538.pct_change | BankName/Partner) + RRSFS.Pop.log.diff + UNRATE.log.diff + UNRATE.log.diff.lag1 , data = data, REML = TRUE)
summary(m)
coef(m)

#                       Estimate Std. Error t value
# HasPartner1           0.012446   0.013825   0.900
m <- lmer(UBPRE524.diff ~ HasPartner + (1 + HasPartner + UBPRB538.pct_change + UBPRE263.pct_change | BankName/Partner) + RRSFS.Pop.log.diff + UNRATE.log.diff + UNRATE.log.diff.lag1 , data = data, REML = TRUE)
summary(m)
coef(m)

#                      Estimate Std. Error t value
#HasPartner            0.02294    0.01888   1.215
m <- lmer(UBPRE524.diff ~ HasPartner + (1 + HasPartner + UBPRB538.pct_change + UBPRE263.pct_change | BankType/BankName/Partner) + RRSFS.Pop.log.diff + UNRATE.log.diff + UNRATE.log.diff.lag1 , data = data, REML = TRUE)
summary(m)

#                     Estimate Std. Error t value
# HasPartner          0.02112    0.02122   0.995
m <- lmer(UBPRE524.diff ~ HasPartner + (1 + HasPartner + UBPRB538.pct_change | BankType/BankName/Partner) + RRSFS.Pop.log.diff , data = data, REML = TRUE)
summary(m)

#                      Estimate Std. Error t value
# HasPartner            0.01950    0.02094   0.931
m <- lmer(UBPRE524.diff ~ HasPartner + (1 + HasPartner + UBPRB538.pct_change | BankType/BankName/Partner) + UNRATE.log.diff + UNRATE.log.diff.lag1 , data = data, REML = TRUE)
summary(m)

#                               Estimate Std. Error t value
#HasPartner                     0.01878    0.01830   1.026
m <- lmer(UBPRE524.diff ~ HasPartner + (1 + HasPartner + UBPRB538.pct_change | BankType/BankName/Partner) + RRSFS.Pop.log.diff + TDSP.log.diff + B069RC1.Pop.CPI.log.diff.lag1 , data = data, REML = TRUE)
summary(m)
coef(m)
