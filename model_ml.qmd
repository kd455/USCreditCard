...
m <- xgboost(booster = "gbtree", data = dEst, params= params_w_group, nrounds=params_w_group$nrounds)
...
result <- map2(partner_banks$Bank, partner_banks$Partner,map_prediction_to_partner, result_obs, all_data) |>
            list_rbind()
