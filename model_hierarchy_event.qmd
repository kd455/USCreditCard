...
m8.7 <- lmer(UBPRE524.diff ~ (1 + UBPRB538.log.diff + UBPR3815.log.diff | BankName/Qtr) + UBPRE524.group.log.diff + TDSP.log.diff + TDSP.log.diff.lag1 + UBPRE524.log.diff.lag1, data = estimation_data, REML = FALSE)
m8.8 <- lmer(UBPRE524.diff ~ (1 + UBPRB538.log.diff + UBPR3815.log.diff | BankName/Qtr) + UBPRE524.group.log.diff + TDSP.log.diff + TDSP.log.diff.lag1 + UBPRE524.log.diff.lag1+ UBPRE524.log.diff.lag4, data = estimation_data, REML = FALSE)
