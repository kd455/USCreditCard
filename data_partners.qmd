...
Interestingly, for all these partnerships, the `r target_label` value appears to increase in the **old** partnership Bank. Clearly we cannot assume patterns of divergence where a Bank's credit card portfolio quality goes up in one Bank and reduces the other. Because the quality is relative to the existing or remaining portfolio.

As mentioned in section @sec-intro-events the event 
The changepoint can be: 
Stable
